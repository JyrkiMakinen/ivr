...
namespace IVR.Datos
{
    public class GeneradorDeDatos
    {
        ...
        public GeneradorDeDatos()
        {
            ...
            CambioEstado cambioEstado1 = new CambioEstado(new DateTime(2023, 1, 25, 10, 40, 00), new DateTime(2023, 1, 25, 10, 40, 56), iniciada);
            CambioEstado cambioEstado2 = new CambioEstado(new DateTime(2023, 1, 25, 10, 40, 56), new DateTime(2023, 1, 25, 10, 41, 21), enCurso);
            CambioEstado cambioEstado3 = new CambioEstado(new DateTime(2023, 1, 25, 10, 41, 21), null, finalizada);
            ...
            CambioEstado cambioEstado4 = new CambioEstado(new DateTime(2023, 1, 29, 05, 00, 51), new DateTime(2023, 1, 29, 05, 02, 01), iniciada);
            CambioEstado cambioEstado5 = new CambioEstado(new DateTime(2023, 1, 29, 05, 02, 01), null, cancelada);
            List<CambioEstado> ce_llamada2 = new List<CambioEstado>() { cambioEstado4, cambioEstado5 };

            CambioEstado cambioEstado6 = new CambioEstado(new DateTime(2023, 2, 13, 01, 05, 01), new DateTime(2023, 2, 13, 01, 05, 50), iniciada);
            CambioEstado cambioEstado7 = new CambioEstado(new DateTime(2023, 2, 13, 01, 05, 50), new DateTime(2023, 2, 13, 01, 06, 50), enCurso);
            CambioEstado cambioEstado8 = new CambioEstado(new DateTime(2023, 2, 13, 01, 06, 50), null, finalizada);
            List<CambioEstado> ce_llamada3 = new List<CambioEstado>() { cambioEstado6, cambioEstado7, cambioEstado8 };

            CambioEstado cambioEstado9 = new CambioEstado(new DateTime(2023, 2, 15, 11, 05, 34), new DateTime(2023, 2, 15, 11, 05, 34), iniciada);
            CambioEstado cambioEstado10 = new CambioEstado(new DateTime(2023, 2, 15, 11, 05, 53), new DateTime(2023, 2, 15, 11, 06, 13), enCurso);
            CambioEstado cambioEstado11 = new CambioEstado(new DateTime(2023, 2, 15, 11, 06, 13), null, cancelada);
            List<CambioEstado> ce_llamada4 = new List<CambioEstado>() { cambioEstado9, cambioEstado10, cambioEstado11 };

            CambioEstado cambioEstado12 = new CambioEstado(new DateTime(2023, 2, 22, 14, 35, 03), new DateTime(2023, 2, 22, 14, 35, 57), iniciada);
            CambioEstado cambioEstado13 = new CambioEstado(new DateTime(2023, 2, 22, 14, 35, 57), null, finalizada);
            List<CambioEstado> ce_llamada5 = new List<CambioEstado>() { cambioEstado12, cambioEstado13 };

            CambioEstado cambioEstado14 = new CambioEstado(new DateTime(2023, 2, 23, 18, 06, 04), new DateTime(2023, 2, 23, 18, 06, 59), iniciada);
            CambioEstado cambioEstado15 = new CambioEstado(new DateTime(2023, 2, 23, 18, 06, 59), null, finalizada);
            List<CambioEstado> ce_llamada6 = new List<CambioEstado>() { cambioEstado14, cambioEstado15 };

            CambioEstado cambioEstado16 = new CambioEstado(new DateTime(2023, 3, 01, 16, 13, 40), new DateTime(2023, 3, 01, 16, 15, 53), iniciada);
            CambioEstado cambioEstado17 = new CambioEstado(new DateTime(2023, 3, 01, 16, 15, 53), null, cancelada);
            List<CambioEstado> ce_llamada7 = new List<CambioEstado>() { cambioEstado16, cambioEstado17 };

            CambioEstado cambioEstado18 = new CambioEstado(new DateTime(2023, 3, 04, 19, 53, 04), new DateTime(2023, 3, 04, 19, 53, 43), iniciada);
            CambioEstado cambioEstado19 = new CambioEstado(new DateTime(2023, 3, 04, 19, 53, 43), new DateTime(2023, 3, 04, 19, 57, 15), enCurso);
            CambioEstado cambioEstado20 = new CambioEstado(new DateTime(2023, 3, 04, 19, 57, 15), null, finalizada);
            List<CambioEstado> ce_llamada8 = new List<CambioEstado>() { cambioEstado18, cambioEstado19, cambioEstado20 };

            CambioEstado cambioEstado21 = new CambioEstado(new DateTime(2023, 3, 09, 04, 05, 56), new DateTime(2023, 3, 09, 04, 06, 34), iniciada);
            CambioEstado cambioEstado22 = new CambioEstado(new DateTime(2023, 3, 09, 04, 06, 34), null, finalizada);
            List<CambioEstado> ce_llamada9 = new List<CambioEstado>() { cambioEstado21, cambioEstado22 };

            CambioEstado cambioEstado23 = new CambioEstado(new DateTime(2023, 3, 15, 23, 45, 26), new DateTime(2023, 3, 15, 23, 46, 18), iniciada);
            CambioEstado cambioEstado24 = new CambioEstado(new DateTime(2023, 3, 15, 23, 46, 18), null, finalizada);
            List<CambioEstado> ce_llamada10 = new List<CambioEstado>() { cambioEstado23, cambioEstado24 };

            CambioEstado cambioEstado25 = new CambioEstado(new DateTime(2023, 4, 06, 15, 14, 28), new DateTime(2023, 4, 06, 15, 16, 48), iniciada);
            CambioEstado cambioEstado26 = new CambioEstado(new DateTime(2023, 4, 06, 15, 16, 48), null, cancelada);
            List<CambioEstado> ce_llamada11 = new List<CambioEstado>() { cambioEstado25, cambioEstado26 };

            CambioEstado cambioEstado27 = new CambioEstado(new DateTime(2023, 4, 10, 07, 30, 27), new DateTime(2023, 4, 10, 07, 30, 43), iniciada);
            CambioEstado cambioEstado28 = new CambioEstado(new DateTime(2023, 4, 10, 07, 30, 43), new DateTime(2023, 4, 10, 07, 38, 00), enCurso);
            CambioEstado cambioEstado29 = new CambioEstado(new DateTime(2023, 4, 10, 07, 38, 00), null, cancelada);
            List<CambioEstado> ce_llamada12 = new List<CambioEstado>() { cambioEstado27, cambioEstado28, cambioEstado29 };

            CambioEstado cambioEstado30 = new CambioEstado(new DateTime(2023, 4, 18, 08, 59, 26), new DateTime(2023, 4, 18, 09, 00, 11), iniciada);
            CambioEstado cambioEstado31 = new CambioEstado(new DateTime(2023, 4, 18, 09, 00, 11), null, finalizada);
            List<CambioEstado> ce_llamada13 = new List<CambioEstado>() { cambioEstado30, cambioEstado31 };

            CambioEstado cambioEstado32 = new CambioEstado(new DateTime(2023, 5, 02, 21, 23, 48), new DateTime(2023, 5, 02, 21, 25, 58), iniciada);
            CambioEstado cambioEstado33 = new CambioEstado(new DateTime(2023, 5, 02, 21, 25, 58), null, finalizada);
            List<CambioEstado> ce_llamada14 = new List<CambioEstado>() { cambioEstado32, cambioEstado33 };

            CambioEstado cambioEstado34 = new CambioEstado(new DateTime(2023, 5, 12, 22, 46, 26), new DateTime(2023, 5, 12, 22, 47, 28), iniciada);
            CambioEstado cambioEstado35 = new CambioEstado(new DateTime(2023, 5, 12, 22, 47, 28), new DateTime(2023, 5, 12, 22, 51, 37), enCurso);
            CambioEstado cambioEstado36 = new CambioEstado(new DateTime(2023, 5, 12, 22, 51, 37), null, finalizada);
            List<CambioEstado> ce_llamada15 = new List<CambioEstado>() { cambioEstado34, cambioEstado35, cambioEstado36 };

            CambioEstado cambioEstado37 = new CambioEstado(new DateTime(2023, 5, 23, 10, 41, 57), new DateTime(2023, 5, 23, 10, 50, 25), iniciada);
            CambioEstado cambioEstado38 = new CambioEstado(new DateTime(2023, 5, 23, 10, 50, 25), null, finalizada);
            List<CambioEstado> ce_llamada16 = new List<CambioEstado>() { cambioEstado37, cambioEstado38 };

            CambioEstado cambioEstado39 = new CambioEstado(new DateTime(2023, 5, 27, 12, 33, 45), new DateTime(2023, 5, 27, 12, 35, 52), iniciada);
            CambioEstado cambioEstado40 = new CambioEstado(new DateTime(2023, 5, 27, 12, 35, 52), null, finalizada);
            ...
            Cliente cliente6 = new Cliente("Marcos Galperín");
